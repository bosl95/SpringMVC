...
public class RequestHeaderServlet extends HttpServlet {
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        request.getLocales().asIterator() // getLocales() : acceptLanguage 정보를 보낸다.
        ...
        System.out.println("request.getContentType() = " + request.getContentType()); // GET 메소드의 경우 content를 안보내기 때문에 null을 반환한다.
